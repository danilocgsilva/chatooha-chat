<template>
  <div class="flex flex-col gap-2">
    <textarea
      ...
      class="w-full h-60 min-h-40 p-3 rounded-lg border resize-y transition-colors focus:outline-none focus:ring-2 [scrollbar-width:thin] [scrollbar-gutter:stable] [resize:vertical]"
      :class="[
